  ...
  return (
    <main className="shell py-8 sm:py-12">
      ...
      <section className="grid gap-5 pb-8 md:grid-cols-4">
        <div className="rounded-[22px] border border-border bg-white p-5"><Clock3 className="size-5 text-[#006d77]" /><p className="mt-6 text-xs font-bold text-[#65736e]">관측시간</p><strong className="mt-1 block font-mono text-xl">{item.timeWindow ?? '미확인'}</strong></div>
